                    ...
                    <v-card-text>
                        ...
                        <v-flex v-for="msg in items" :key="msg._id" >
                            <div v-bind:class="{'right' :!msg.who}" >
                                <v-chip text-color="white" v-bind:class="{'primary' :!msg.who}" >{{msg.message}}</v-chip>
                            </div><br><br>
                        </v-flex>
                        </div>
                    </v-card-text>
    ...
    export default {
        ...
        computed:{
            ...
            filesc(){
                ...
                axios.get('http://localhost:9000/api/files/'+this.sujet._id).then((resp) => {
            ...
            items(){
                ...
                axios.get('http://localhost:9000/api/messages/'+this.sujet._id).then((resp) => {
        ...
        methods: {
            ...
            initialize() {
                ...
                axios.get('http://localhost:9000/api/sujetByUser/' + this.$store.getters.authUser._id).then((resp) => {
